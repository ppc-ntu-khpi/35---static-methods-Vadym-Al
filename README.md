...
## Виконання
### Вступ
Я обрав завдання під номером 2. Чому, запитаєте ви ? Да хто його знає... Якщо чесно я обрав друге завдання через те, що не хотів виконувати 1, бо я частенько буваю першим варіантом ну і вирішив змінити шаблони !)) Тимпаче в мене було багато ідей як це можна вирішити.
### Дещо про середу розробки
Тут така річ, ну не можу я писати в NetBeans, ну взагалі ніяк, ця програма мене відторгає ))) Тому я знайшов спосіб ! Я відкрив проект одночасно в двух програмах, все що стосувалось коду я писав в IDEA, а що коментаріїв і документації в NeatBeans. Дааа, такий сопі спосіб, хтось мене навіть може назвати "збоченець", Но, мені подобається ))
### Хід роботи
Насправді я не міг уявити, що завдання я вибрав достатьно халтурне, це доречі я взнав вже після того як погуглив. Спочатку намагався самому все реалізувати, ось наприклад як малоб виглядіти метод для переведення з 10 в 2 систему:
